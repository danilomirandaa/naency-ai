...
// Naency: legenda na ordem das séries, e não em ordem alfabética (padrão do Recharts).
const ChartLegend = ({ itemSorter = null, ...props }: React.ComponentProps<typeof RechartsPrimitive.Legend>) => (
  <RechartsPrimitive.Legend itemSorter={itemSorter} {...props} />
);
