          ...
          return (
            <li
              ...
              className={classMerge(
                'grid grid-cols-[auto_1fr_auto] items-center gap-x-3 gap-y-2 border-border-neutral-subtle border-b px-4 py-3 last:border-b-0 md:grid-cols-[auto_minmax(0,1fr)_14rem_auto]',
            ...
            >
              ...
              <div className="flex min-w-0 flex-col">
                <Text size="sm" weight="medium" className={classMerge('truncate', !row.include && 'text-typography-neutral-secondary')}>
                  {row.description}
                </Text>
              ...
              <MoneyValue
                ...
                size="sm"
                className="text-right tabular-nums md:order-last"
              />
